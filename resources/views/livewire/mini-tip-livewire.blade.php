<div class="sok-NewTab">
   <span class="sok-NewTab-contentContainer">
      <span class="sok-NewTab-contentHeader">
         <span class="sok-Chip sok-Chip-{{ strtolower($tip->lang) }}">{{ $tip->lang }}</span>
      </span>
      <div class="sok-MarkdownRenderer">
         <div class="mb-2" id="render" data-markdown="{{ $tip->content }}"></div>
      </div>
   </span>
  </div>
      ...
      var md = window.markdownit({
        ...
        highlight: function(str, lang) {
          if (lang && hljs.getLanguage(lang)) {
            try {
              return `<div class="sok-MarkdownSyntaxHighlighter">` +
                hljs.highlight(str, {
                  language: lang,
                  ignoreIllegals: true
                }).value +
